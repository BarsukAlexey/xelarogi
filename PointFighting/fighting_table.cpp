...
//        ui->widgetFooterHorizontalLayout->insertWidget(1, pushButtonDoctorRed);
...
//        ui->widgetFooterHorizontalLayout->insertWidget(3, cancelLastPenalty);
...
//        ui->widgetFooterHorizontalLayout->insertWidget(4, pushButtonStop);

//        connect(pushButtonStart, &QPushButton::clicked, [f](){f->pressedKeySpace();});
//        connect(pushButtonDoctorRed, &QPushButton::clicked, [f](){f->pressDoctor();});
