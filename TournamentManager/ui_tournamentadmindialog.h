...
public:
    ...
    QPushButton *pushButtonTournamentGrid;
    ...
    void setupUi(QDialog *TournamentAdminDialog)
    {
        ...
        pushButtonTournamentGrid = new QPushButton(TournamentAdminDialog);
        pushButtonTournamentGrid->setObjectName(QStringLiteral("pushButtonTournamentGrid"));
        pushButtonTournamentGrid->setGeometry(QRect(240, 180, 141, 51));
    ...
    void retranslateUi(QDialog *TournamentAdminDialog)
    {
        ...
        pushButtonTournamentGrid->setText(QApplication::translate("TournamentAdminDialog", "\320\242\321\203\321\200\320\275\320\270\321\200\320\275\320\260\321\217 \321\201\320\265\321\202\320\272\320\260", 0));
